# Run GitHub CI in BaseVM 

![Test](https://github.com/portsbuild-vm/base-vm/workflows/Test/badge.svg)
...
>
> Just describe what you want in plain language, e.g. *"run my tests on BaseVM"* or *"check that my project builds on BaseVM aarch64"*, and the agent generates a correct, ready-to-commit `test.yml`. It will:
>
